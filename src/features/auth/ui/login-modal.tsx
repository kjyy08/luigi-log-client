...
export const LoginModal = () => {
    ...
    return (
        <Dialog open={isLoginModalOpen} onOpenChange={closeLoginModal}>
            <DialogContent className="sm:max-w-md overflow-hidden p-0 border-none bg-transparent shadow-none">
                <div className="relative flex flex-col items-center justify-center p-6 bg-background rounded-lg border shadow-xl">
                    {/* Background Decoration - simplified for modal */}
